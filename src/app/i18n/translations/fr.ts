export const fr = {
  ...
  dataSources: {
    ...
    intro:
      'Gérez vos points de virage (CUP) et vos espaces aériens pour la carte et le profil sécurité. Chaque bloc suit le même principe : source active, import, puis choix dans les listes.',
    cup: {
      sectionTitle: 'Points de virage (CUP)',
      statusAria: 'Base CUP active',
      statusSubtitle: 'Points de virage',
      activeBadge: 'Base active',
      activeEmpty: 'Aucune base chargée',
      activeEmptyHint: 'Importez un fichier .cup ou choisissez une source ci-dessous.',
      loadedAt: 'Chargée le {{date}}',
      import: 'Importer .cup',
      export: 'Exporter .cup',
      activate: 'Utiliser',
      active: 'Active',
      integratedAria: 'Points de virage intégrés',
      integratedTitle: 'Points de virage intégrés',
      integratedHint:
        'Fichiers .cup placés dans public/assets/cup/ (liste générée au build). Le premier du dossier (ordre alphabétique) est chargé par défaut au premier lancement.',
      integratedKind: 'Fichier .cup intégré',
      noIntegrated: 'Aucune base intégrée dans la configuration.',
      importedAria: 'Fichiers CUP importés',
      importedTitle: 'Fichiers importés',
      importedHint:
        'Fichiers .cup chargés depuis votre appareil. Le choix est mémorisé localement pour réutilisation.',
      noImported: 'Aucun fichier importé.',
      waypointCount: '{{count}} points',
      removeImported: 'Supprimer l’import',
      removeImportedHeader: 'Supprimer le fichier',
      removeImportedMessage:
        'Retirer « {{label}} » de la liste et effacer la copie locale ? La base en mémoire n’est pas modifiée si elle est encore active.',
      clearDb: 'Vider',
      ...
      clearDbAccept: 'Vider',
      cleared: 'Base vidée.',
      urlAria: 'Charger CUP depuis une URL',
      urlTitle: 'Charger depuis une URL',
      urlPlaceholder: 'https://…/fichier.cup',
      urlLoad: 'Charger'
    },
    airspace: {
      sectionTitle: 'Espaces aériens',
  ...
  cupUrl: {
    ...
    defaultBase: 'AAPCA waypoints 11 juin 2025',
  ...
  safetyProfile: {
    ...
    profileResizeHandle: 'Redimensionner la hauteur de la coupe',
    profileShrink: 'Réduire la coupe (plus de place pour la carte)',
    profileExpand: 'Agrandir la coupe',
